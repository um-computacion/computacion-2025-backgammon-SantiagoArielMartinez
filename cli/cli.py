"""
Módulo que implementa la interfaz de línea de comandos (CLI) para Backgammon.
"""
...
class CLI:
    """
    Clase que implementa la interfaz de línea de comandos para jugar Backgammon.
    Permite interactuar con el juego mediante texto en la terminal.
    """
    def __init__(self):
    ...
    def realizar_movimiento(self, jugador):
        ...
        from core.exceptions import NoEsTuTurno, SinDados, PosicionInvalida, PosicionVacia
        try:
            ...
            print("Error: Ese dado no está disponible")
            return False
        except (PosicionInvalida, PosicionVacia):
            print("Error: Posición inválida o vacía")
            return False
